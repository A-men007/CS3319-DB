...
SELECT * FROM bustrip;
INSERT INTO bustrip VALUES (1,'Castles of Germany','2022-1-1','2022-1-17','Germany','VAN1111');
INSERT INTO bustrip VALUES (2,'Tuscany Sunsets','2022-3-3','2022-3-14','Italy','TAXI222');
INSERT INTO bustrip VALUES (3,'California Wines','2022-5-5','2022-5-10','USA','VAN2222');
INSERT INTO bustrip VALUES (4,'Beaches Galore','2022-4-4','2022-4-14','Bermuda','TAXI222');
INSERT INTO bustrip VALUES (5,'Cottage Country','2022-6-1','2022-6-22','Canada','CAND123');
INSERT INTO bustrip VALUES (6,'Arrivaderci Roma','2022-7-5','2022-7-15','Italy','TAXI111');
INSERT INTO bustrip VALUES (7,'Shetland and Orkney','2022-9-9','2022-9-29','UK','TAXI111');
INSERT INTO bustrip VALUES (8,'Disney World and Sea World','2022-6-10','2022-6-20','USA','VAN2222');
INSERT INTO bustrip VALUES (9,'Greek Islands','2022-3-3','2022-3-17','Germany','TAXI111');
INSERT INTO bustrip VALUES (10,'Mexican Cartels','2022-4-4','2022-4-17','Mexico','TAXI111');
SELECT * FROM bustrip;
...
-- show some updates
SELECT * FROM passport;
UPDATE passport SET citizenshipcountry = "Germany" WHERE passengerid IN (SELECT passengerid FROM passenger WHERE firstname="Dwight" AND lastname="Schrute");
SELECT * FROM passport;

SELECT * FROM bustrip;
UPDATE bustrip SET assignedbus="VAN1111" WHERE country="USA";
SELECT * FROM bustrip;
